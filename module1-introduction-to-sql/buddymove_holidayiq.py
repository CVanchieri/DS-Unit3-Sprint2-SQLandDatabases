...
#1.count how many rows you have - it should be 249! #249
curs1 = conn.cursor()
print('Total # of rows =', curs1.execute(q1).fetchall())
#2.how many users who reviewed at least 100 nature in the category also reviewed at least 100 in the shopping category?
curs2 = conn.cursor()
print("Total # of reviews from 'BuddyMoveHoliday' (100+ Nature and 100+ Shopping) =", curs2.execute(q2).fetchall())
#3.(stretch) what are the average number of reviews for each category?
curs3 = conn.cursor()
print('Average # of reviews for each category =', curs3.execute(q3).fetchall())
